...
def main():
    ...
    # /home/felipe/Downloads/Canastos
    # print(glob.glob('/home/felipe/Downloads/Canastos/*.png'))
    # i = 1
    # for pic in glob.glob('/home/felipe/Downloads/Canastos/*.png'):
    #     rgb_img = cv2.imread(pic)
    #     predictions = agnostic_segmentation.segment_image(rgb_img, args.model_path)
    #     print(predictions['instances'].pred_boxes)
    #     seg_img = agnostic_segmentation.draw_segmented_image(rgb_img, predictions)
    #     # cv2.imshow('segmented_image', seg_img)
    #     cv2.imwrite('segmented_image_'+str(i)+'.png', seg_img)
    #     i+=1
