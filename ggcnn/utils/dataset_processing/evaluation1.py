...
def grasp_info(grasp_width_img, grasp_q_img, grasp_angle_img, grasps):
    maxgrasps = []
    for i in range(len(grasps)):
        grasp = dict()
        grasp['q'] = grasp_q_img[grasps[i].center]
        grasp['pix'] = [grasps[i].center[0], grasps[i].center[1]]
        grasp['ang'] = grasp_angle_img[grasps[i].center[0], grasps[i].center[1]]*180/math.pi
        grasp['width'] = grasp_width_img[grasps[i].center[0], grasps[i].center[1]]
        maxgrasps.append(grasp)
    return maxgrasps
